<div class="header">
            ...
            <div class="left-menu">
                <a class="left-menu__item" href="index.php?xem=canhan&id=1"><span id="speed-icon"></span>Thông tin cá nhân</a>
                <a class="left-menu__item" href="index.php?xem=taikhoan&id=1"><span class="icon" id="user-icon"></span>Quản lý tài khoản</a>
                 <a class="left-menu__item" href="index.php?xem=thongke&id=1"><span id="speed-icon"></span>Thống kê</a>
